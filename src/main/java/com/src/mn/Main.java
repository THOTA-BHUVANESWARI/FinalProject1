            ...
            switch (choice) {
                ...
                case 4: // Update Charity
                    ...
                    if (updCharity != null) {
                        ...
                        String newName = sc.nextLine();
                        System.out.print("New Description (" + updCharity.getDescription() + "): ");
                        String newDesc = sc.nextLine();
                        ...
                        updCharity.setDescription(newDesc.isEmpty() ? updCharity.getDescription() : newDesc);
